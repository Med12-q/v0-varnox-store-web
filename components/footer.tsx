      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-border/50 flex flex-col items-center gap-4">
          <p className="text-sm text-muted-foreground text-center">
            &copy;2026 TRACK_X powered by Varnox&bull;Prime
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-[#0088cc]/10 hover:bg-[#0088cc]/20 flex items-center justify-center transition-colors group"
              aria-label="Telegram"
            >
              <svg
