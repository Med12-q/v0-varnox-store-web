      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <Card className="glass border-border/50 overflow-hidden">
            <div className="relative h-80 lg:h-full min-h-[400px] bg-gradient-to-br from-primary/10 via-accent/5 to-secondary/20 flex items-center justify-center">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(255,50,50,0.1),transparent_70%)]" />
              <div className="relative">
                <div className="w-32 h-32 rounded-3xl bg-card/80 border border-border/50 flex items-center justify-center neon-border">
          ...
          <div>
            ...
            <div className="mt-8 p-4 rounded-lg bg-secondary/50 border border-border/50">
              <p className="text-sm text-muted-foreground">
                {language === 'fr'
                  ? 'Support 24/7 inclus. Mises à jour gratuites à vie. Installation assistée disponible.'
